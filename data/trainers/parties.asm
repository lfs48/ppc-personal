...
if DEF(FAITHFUL)
	...
	db 24, NINETALES, NO_ITEM, 64, ABILITY_1 | QUIRKY, FEMALE
		db WILL_O_WISP, CONFUSE_RAY, FIRE_SPIN, HEX
endc
...
; ================
	...
	db 38, JYNX, NO_ITEM, 112
		db PSYCHIC_M, DRAIN_KISS, ICE_BEAM, NASTY_PLOT
...
if DEF(FAITHFUL)
	...
	db 44, CHARIZARD, NO_ITEM, 128, ABILITY_1 | QUIRKY, FEMALE
		db FLAMETHROWER, CRUNCH, FLAME_CHARGE, DRAGON_PULSE
endc
	db 44, DRAGONAIR, NO_ITEM, 128, ABILITY_1 | QUIRKY, FEMALE
		db THUNDER_WAVE, THUNDERBOLT, ICE_BEAM, DRAGON_PULSE
	db 47, KINGDRA, SHELL_BELL, 128, ABIL_KINGDRA_SNIPER | QUIRKY, FEMALE
		db ICE_BEAM, AGILITY, DRAGON_PULSE, SURF
	db -1 ; end
...
; ================
	...
	db 40, NINETALES, NO_ITEM, 120 | ALOLAN_FORM
		db ICE_BEAM, MOONBLAST, HEALINGLIGHT, SHADOW_BALL
...
; ================
	...
	db 73, DEWGONG, LEFTOVERS
		db SURF, ICE_BEAM, REST, SLEEP_TALK
	db 72, NINETALES, PINK_BOW | ALOLAN_FORM
		db ICE_BEAM, MOONBLAST, HEALINGLIGHT, SHADOW_BALL
